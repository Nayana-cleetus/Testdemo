...
public class GrantBudgetHeadWiseUtilSmryDto implements Serializable{
    ...
    private BigDecimal expenditureAsonDtCenterAmt;
   ...
   // private BigDecimal availableGrantAmt;
    ...
    private List<String> surrenderTo;
	...
	public BigDecimal getExpenditureAsonDtCenterAmt() {
		return expenditureAsonDtCenterAmt;
	}


	public void setExpenditureAsonDtCenterAmt(BigDecimal expenditureAsonDtCenterAmt) {
		this.expenditureAsonDtCenterAmt = expenditureAsonDtCenterAmt;
	}
	...
	public List<String> getSurrenderTo() {
		return surrenderTo;
	}


	public void setSurrenderTo(List<String> surrenderTo) {
		this.surrenderTo = surrenderTo;
	}
