...
System.out.println(grantDto.getItemId());
	  ...
	  List<GrantBudgetHeadWiseUtilSmryEntity> itemClassWiseEntity  = grantBudgetHeadWiseUtilSmryRepo.getSurrenderItemClassWiseDetails(grantDto.getFinYear(), grantDto.getRcFlag(), grantDto.getDemandId(),
